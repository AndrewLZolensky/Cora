...
class Reasoner():
    ...
    def query_in_knowledge_base(self, query: Union[AtomicProposition, Conjunction]) -> bool:
    ...
    def forward_chain(self, query: AtomicProposition) -> bool:
        ...
        num_new_facts = 0
        while True:
            if (self.query_in_knowledge_base(query=query)):
            ...
            for implication in working_implications.copy():
                ...
                satisfied = self.query_in_knowledge_base(thing_to_satisfy)
                if satisfied:
    ...
    def backward_chain(self, query: AtomicProposition) -> bool:
        pass
     

if __name__ == "__main__":                   
    # propositions
    propA = "timmy is hungry"
    propB = "timmy is angry"
    propC = "timmy is stressed"
    propD = "timmy throws a tantrum"
    propE = "timmy is sorry"
    ...
    # print(logos)
    # print(logos.forward_chain(query))

    print(logos.forward_chain(AtomicProposition(proposition="jerry is healthy")))